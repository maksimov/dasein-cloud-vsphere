...
public class RESTMethod {
    static private final Logger logger = Vsphere.getLogger(RESTMethod.class);
    static private final Logger wire   = Vsphere.getWireLogger(RESTMethod.class);
    ...
    public RESTMethod(@Nonnull Vsphere provider) { this.provider = provider; }
